...
The `Sort` and `Filter` button on the `Home` tab shown in Figure \@ref(fig:sorting) sort the data in ascending or descending depending on the selection from the sub-menu. 
