...
2.	From the `Home Menu`, select `Copy` (the shortcut with the keyboard for this process is `Ctrl-C` or `Command -C`). Notice that the range of cells being copied now has a blinking border around it.
