# Time Series and Measures of Central Tendency
...
knitr::include_graphics('insert-column-mac.png')
```
...
knitr::include_graphics('numbers-ribbon.png')
```
...
knitr::include_graphics('scatter-options.png')
```
...
knitr::include_graphics('adjust-scatter.png')
``` 
...
knitr::include_graphics('adjust-axis.png')
```

**Practice 1:**

Construct a time series for the *High* prices in your data set.

**Practice 2:**

Calculate your data set's mean, mode, median and sample standard deviation of the *Close* prices.
