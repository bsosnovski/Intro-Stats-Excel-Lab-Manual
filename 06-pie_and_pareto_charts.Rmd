...
In this lab, you will build pie and Pareto charts using Excel.
...
knitr::include_graphics('degree-earned-data.png')
```
...
knitr::include_graphics('pie-chart.png')
```
...
knitr::include_graphics('pie-chart-design.png')
```
...
4. In the Sort dialog box that appears. Select the following options:
...
knitr::include_graphics('sorting-earn-degree-data.png')
```
