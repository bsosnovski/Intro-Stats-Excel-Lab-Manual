...
r, echo=FALSE}
m=matrix(c(Min,18, Q1, 24.50, Q2, 38, Q3, 44.25, Max, 58, Median, 38))

knitr::kable(
  matrix(c(Min,18, Q1, 24.50, Q2, 38, Q3, 44.25, Max, 58, Median, 38), nrow = 2, byrow = TRUE, longtable = TRUE, booktabs = TRUE,
  caption = 'Example of a five-number-summery.'
)
...
```{r box-and-whisker-menu, echo=FALSE, fig.align = 'center', out.width='55%', fig.show='hold', fig.cap='Box and Whisker option in the Chart ribbon of the Insert tab.', fig.alt = 'A screenshot of the Box and Whisker option in Chart ribbon of the Insert tab.'}
knitr::include_graphics('box-and-whisker-menu.png')
```
...
knitr::include_graphics('box-and-whisker-plot.png')
```
...
knitr::include_graphics('format-axis.png')
```
...
knitr::include_graphics('final-box-plot.png')
```
