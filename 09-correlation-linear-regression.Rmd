...
knitr::include_graphics('images/correl-funciton-mac.png')
```

```{r correl-funciton-pc, echo=FALSE, fig.align = 'center', out.width='50%', fig.show='hold', fig.cap='Dialog window of the Correl function on PC.', fig.alt = 'A screenshot of dialog box of the Correl function on PC.'}
knitr::include_graphics('images/correl-funciton-mac.png')
```
