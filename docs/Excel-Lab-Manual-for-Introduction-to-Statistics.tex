...
If obtaining Excel via Microsoft 365, download the software to your machine. Do not run Excel from the cloud. Running it from the cloud does not give students access to the \emph{Analysis ToolPak} (see \emph{Section} \textbf{\emph{\ref{toolpak}}}).

\hypertarget{the-excel-window}{%
\section{The Excel Window}\label{the-excel-window}}

Note that in the Excel Windows shown in Figures \textbf{\ref{fig:window-pc}} and \textbf{\ref{fig:window-mac}}, the title bar shows \texttt{Book1} as a temporary name for the file. When opening a new Excel file (also called a Workbook, see \emph{Section} \textbf{\emph{\ref{workbook}}}), it has a suggested temporary name, \texttt{Book1}, \texttt{Book2}, etc, depending on how many new files are open before saving them. When saying it for the first, Excel will prompt the user to rename it.
...
{\centering \includegraphics[width=1\linewidth]{images/window-pc} 
...
{\centering \includegraphics[width=0.6\linewidth]{images/saving-mac2} 

}

\caption{Dialog window when saving a workbook on a MAC.}\label{fig:saving-dialog-box-mac}
\end{figure}
...
{\centering \includegraphics[width=0.85\linewidth]{images/saving-options} 
...
\item
  In the Options dialog window, click on the \texttt{Save} option on the left.
\item
...
{\centering \includegraphics[width=0.85\linewidth]{images/autosave-pc} 
...
\item
  Select the \texttt{AutoSave} or \texttt{AutoRecover} info in every check window, and then enter how frequently you want to save the Excel files.
\end{enumerate}

\begin{figure}

{\centering \includegraphics[width=0.45\linewidth]{images/autosave-mac1a} 
...
{\centering \includegraphics[width=0.55\linewidth]{images/autosave-mac1b} 
...
{\centering \includegraphics[width=0.5\linewidth]{images/autosave-mac2} 
...
{\centering \includegraphics[width=0.6\linewidth]{images/gridlines-mac} 
...
{\centering \includegraphics[width=0.4\linewidth]{images/cell-selection} 
...
{\centering \includegraphics[width=0.4\linewidth]{images/text-formatting} 
...
Numbers can be formatted to represent dollar amounts (\$) or percent form (\%) and can be shown with commas in large numbers (,). The number of decimal places to which numbers are carried is also adjustable. All these options appear on the formatting menu bar. Other options are accessible by \texttt{RIGHT-clicking} on a cell and selecting Format Cells.

\begin{figure}

{\centering \includegraphics[width=0.4\linewidth]{images/number-formatting} 
...
{\centering \includegraphics[width=0.9\linewidth]{images/insert-function-dialog-mac} 

}

\caption{Dialog window of Insert Function on MAC.}\label{fig:insert-function-dialog-mac}
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{images/initial-comp} 
...
\hypertarget{class-limit-calculations}{%
\section{Class Limit Calculations}\label{class-limit-calculations}}
...
{\centering \includegraphics[width=0.5\linewidth]{images/class-limits-comp} 
...
{\centering \includegraphics[width=0.6\linewidth]{images/histogram-mac} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/raw-histogram} 
...
\item
  Select \texttt{\textgreater{}Home\textgreater{}Delete} (you can also do this by \texttt{RIGHT-clicking} on the selected cells and then the option \texttt{Delete}).
\end{enumerate}
...
{\centering \includegraphics[width=1\linewidth]{images/delete-more-row} 
...
\tightlist
\item
  \texttt{RIGHT-click} on any one of the vertical bars of the graph and then select \texttt{Format\ Data\ Point} (or \texttt{Format\ Data\ Series}). Alternatively, you can also double-click with your mouse on a vertical for that.
\item
...
\tightlist
\item
  \texttt{RIGHT-click} on any vertical bar of the graph. From the menu, click the option \texttt{Select\ Data}.
\item
...
{\centering \includegraphics[width=1\linewidth]{images/adjusting-horizontal-axis-mac} 
...
{\centering \includegraphics[width=0.9\linewidth]{images/adjusting-horizontal-axis-pc} 
...
{\centering \includegraphics[width=0.7\linewidth]{images/relabel-horiontal-axis-pc} 
...
\item
  ...
  in a window. Change the title to \emph{MA336 Exam Scores}.
\item
...
{\centering \includegraphics[width=0.7\linewidth]{images/adjusted-histogram} 
...
{\centering \includegraphics[width=0.8\linewidth]{images/descriptive-stats1} 
...
{\centering \includegraphics[width=0.4\linewidth]{images/summary-stats} 
...
{\centering \includegraphics[width=0.6\linewidth]{images/insert-column-mac} 
...
{\centering \includegraphics[width=0.35\linewidth]{images/numbers-ribbon} 
...
{\centering \includegraphics[width=0.4\linewidth]{images/pie-chart} 
...
{\centering \includegraphics[width=1\linewidth]{images/pie-chart-design} 
...
{\centering \includegraphics[width=0.7\linewidth]{images/sorting-earn-degree-data} 
...
{\centering \includegraphics[width=1\linewidth]{images/percentiles} 
...
The function \texttt{PERCENTRANK.INC(array,\ x,\ {[}significance{]})} calculates a specific value's relative position within a data set, expressed as a percentile rank between 0 and 1, inclusive. \emph{Significance} is an optional argument. that identifies the number of significant digits for the returned percentage value. If omitted, \texttt{PERCENTRANK.INC} uses three digits (0.xxx).
...
{\centering \includegraphics[width=0.35\linewidth]{images/percentranks} 
...
{\centering \includegraphics[width=0.35\linewidth]{images/number-ribon-percentages} 
...
{\centering \includegraphics[width=0.45\linewidth]{images/box-and-whisker-menu} 
...
{\centering \includegraphics[width=0.55\linewidth]{images/box-and-whisker-plot} 
...
{\centering \includegraphics[width=0.35\linewidth]{images/format-axis} 
...
{\centering \includegraphics[width=0.55\linewidth]{images/final-box-plot} 
...
\tightlist
\item
  For the title, replace \emph{Waiting} with \emph{Old Faithful Data}.
\item
  Click \texttt{Add\ Chart\ Element\ \textgreater{}\ Axis\ Title\ \textgreater{}\ More\ Axis\ Title\ Options}. This will add an automatic \emph{x}-axis title and \emph{y}-axis title.
\item
  Click the \emph{x}-axis title and replace it with \emph{Duration of Eruptions (in Minutes)}.
\item
  Click the \emph{y}-axis title and replace it with \emph{Time Until the Next Eruption (in Minutes)}.
\item
  \texttt{RIGHT-click} on the horizontal axis and then select \texttt{Format\ Axis} to change the axis format in the plot. Set the \emph{Minimum Bound} as 1. Adjusting the axis removes
\item
  \texttt{RIGHT-click} on the vertical axis and then select \texttt{Format\ Axis} to change the axis format. Set the \emph{Minimum Bound} as 30 and \emph{Maximum Bound} as 100.
\end{enumerate}

The adjusted box plot is shown in Figure \textbf{\ref{fig:final-scatter-plot}}.

\begin{figure}

{\centering \includegraphics[width=0.65\linewidth]{images/final-scatter-plot} 

}

\caption{ Adjusted scatter plot.}\label{fig:final-scatter-plot}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth]{images/correl-funciton-mac} 
...
{\centering \includegraphics[width=0.4\linewidth]{images/trendline} 

}

\caption{Trendline options.}\label{fig:trendline}
\end{figure}

\hypertarget{practice-7}{%
\section{Practice}\label{practice-7}}

For this exercise, you will switch the explanatory and response variables. That means changing the roles of \emph{x} and \emph{y} values for the same data set. Following the guidelines above, use Excel to:
...
\item
  Determine the regression line's slope and y-intercept.
\item
  Draw the regression line in the scatter plot.
\end{enumerate}

\hypertarget{coin-toss-simulation}{%
\chapter{Coin Toss Simulation}\label{coin-toss-simulation}}
